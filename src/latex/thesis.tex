...
un riassunto di un massimo di 3 pagine sulla tesi in cui siano
evidenziati:~ 1. titolo, nome del laureando, nomi dei relatori ; 2.
scopo della tesi e breve descrizione nell' ambito di ricerca in cui si
situa (specie nel caso di tesi svolte in collaborazione con altri) 3.
contributi personali e risultati ottenuti.
