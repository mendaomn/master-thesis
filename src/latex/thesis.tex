...
\begin{figure}[htbp]
\centering
\includegraphics{./src/content/tail/img/oldCAM-annotations.png}
\caption{Old CAM, Annotations}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics{./src/content/tail/img/oldCAM-overview.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{./src/content/tail/img/sketch-overview.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{./src/content/tail/img/mockup-overview.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{./src/content/tail/img/overview-A.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{./src/content/tail/img/overview-B.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{./src/content/tail/img/review-open.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{./src/content/tail/img/review-breadcrumb.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{./src/content/tail/img/analyze-screen.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{./src/content/tail/img/review-notification.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{./src/content/tail/img/review-summary.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{./src/content/tail/img/review-sidebar-animation.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{./src/content/tail/img/review-notification-animation.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{./src/content/tail/img/overview-appshell.png}
\caption{Overview screen, application shell}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics{./src/content/tail/img/review-appshell.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{./src/content/tail/img/overview-jsprofile.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{./src/content/tail/img/csstriggers.png}
...
\begin{figure}[htbp]
\centering
\includegraphics{./src/content/tail/img/architecture.png}
